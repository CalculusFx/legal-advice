        ...
        <nav className={mobileMenuOpen ? 'mobile-open' : ''}>
          <ul>
            <li onMouseEnter={close}>
              <a href={isHomePage ? "#about" : "/"} onClick={(e) => {
            ...
            >
              <li className="has-mega" onClick={(e) => {
                ...
                <a href={isHomePage ? "#services" : "/"} onClick={(e) => {
                  if (!isHomePage) {
                    e.preventDefault();
                ...
                }} aria-expanded={megaOpen}>{t("nav.services")}</a>
              </li>
            ...
            <li onMouseEnter={close}>
              <a href={isHomePage ? "#articles" : "/"} onClick={(e) => {
                setMobileMenuOpen(false);
                if (!isHomePage) {
                  e.preventDefault();
            ...
            <li onMouseEnter={close}>
              <a href={isHomePage ? "#contact" : "/"} onClick={(e) => {
                setMobileMenuOpen(false);
                if (!isHomePage) {
                  e.preventDefault();
